...
use Test\BrcodePayment\TestBrcodePayment;
...
class TestPaymentPreview
{
    ...
    {
        $previews = [];
        array_push($previews, new PaymentPreview(["id" => "00020126390014br.gov.bcb.pix0117valid@sandbox.com52040000530398654041.005802BR5908Jon Snow6009Sao Paulo62110507sdktest63046109"]));
        array_push($previews, new PaymentPreview(["id" => TestBoletoPayment::example(false)->line]));
