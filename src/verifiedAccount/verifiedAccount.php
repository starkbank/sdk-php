...
class VerifiedAccount extends Resource
{
    ...
    ## Parameters (optional):
        - tags [array of strings, default null]: array of strings for reference when searching for verified accounts. ex: ["employees", "monthly"]
    ...
    ## Attributes (return-only):
        ...
        - created [DateTime]: creation datetime for the verified account.
        - updated [DateTime]: latest update datetime for the verified account.
     */
    ...
    Send an array of VerifiedAccount objects for creation in the Stark Bank API

    ## Parameters (required):
        - verifiedAccounts [array of VerifiedAccount objects]: array of VerifiedAccount objects to be created in the API
    ...
    ## Return:
        - array of VerifiedAccount objects with updated attributes
     */
    ...
    Receive an enumerator of VerifiedAccount objects previously created in the Stark Bank API
    ...
    ## Return:
        - enumerator of VerifiedAccount objects with updated attributes
     */
