...
class Transaction extends Resource
{
    ...
    ## Parameters (required):
        - amount [integer]: amount in cents to be transferred. A negative value represents a cash-out. ex: 1234 (= R$ 12.34)
    ...
    /**
     * @deprecated Function deprecated since v2.22.0
    # Create Transactions (removed)

    create is deprecated and disabled in this SDK: calling it raises an Exception immediately, without making any request. Transactions can no longer be created directly through this function — they are now created automatically by other operations (Transfer, Boleto payment, etc.).
     */
    public static function create($transactions, $user = null)
    {
        throw new Exception("Function deprecated since v2.22.0");
    }
